...
router.get('/edit/:id', function(req, res) {
  ...
  SubCategoryModel.findById(req.params.id, function(err, db_subcategory_array) {
      if (err) {
          ...
          console.log("my sub cat array is : ", db_subcategory_array);
          CategoryModel.find(function(err,db_category_array){
            if(err){
              console.log(err);
            }else{
              console.log(db_category_array);
              res.render('admin/subcategory/edit-subcategory', { subcategory_array: db_subcategory_array, cat_array: db_category_array });
            }
          }).lean();
      }
  }).lean();
